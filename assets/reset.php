<?php
  ...
  bindtextdomain('stocks', GLANCR_ROOT ."/modules/stocks/locale");
  textdomain('stocks');
  bind_textdomain_codeset('stocks', 'UTF-8');
?>
...
<head>
	...
	<title><?php echo _("ppStocksResetConfig"); ?></title>
		...
		<section>
			<div class="row">
				<div class="small-12 columns">
					...
					<h3><?php echo _("ppStocksTitle"); ?></h3>

					<p>
						<?php echo _("ppStocksResetConfigMessage"); ?>
					</p><br /><br />
